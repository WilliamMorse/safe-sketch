...
var $author$project$Main$defaultEvent = {height: 0, isPrimary: false, offsetX: 0, offsetY: 0, pageX: 0, pageY: 0, pointerId: -1, pointerType: $author$project$Pointer$Mouse, pressure: 0, screenX: 0, screenY: 0, tangentialpressure: 0, tiltX: 0, tiltY: 0, timestamp: 0, twist: 0, width: 0};
...
var $author$project$Main$init = _Utils_Tuple2(
	A2(
		...
		_List_fromArray(
			[$author$project$Main$defaultEvent]),
		_List_Nil),
...
var $author$project$Main$penMoveEvent = _Platform_incomingPort('penMoveEvent', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$penMoveEvent($author$project$Main$Move)
			]));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var ev = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeBundle, ev);
				if (_v1.$ === 'Ok') {
					var bundle = _v1.a;
...
var $author$project$Main$pressureChart = function (model) {
	return $mdgriffith$elm_ui$Element$html(
		A3(
			...
			A2(
				...
				F2(
					function (x, y) {
						return A2($author$project$Main$Point, x, y.pressure);
					}),
				model.events)));
};
...
var $author$project$Vector$length2 = function (_v0) {
	var a1 = _v0.a;
	var a2 = _v0.b;
	return A2($elm$core$Basics$pow, a1, 2) + A2($elm$core$Basics$pow, a2, 2);
};
var $author$project$Vector$length = function (a) {
	return A2(
		$elm$core$Basics$pow,
		$author$project$Vector$length2(a),
		0.5);
};
...
var $author$project$Vector$rel = F2(
	function (a, b) {
		return A2($author$project$Vector$subtract, a, b);
	});
var $author$project$Main$velocity = function (model) {
	var t1 = A2(
		$elm$core$List$map,
		function (e) {
			return e.timestamp;
	...
	var posDiff = A2(
		$elm$core$List$map,
		$author$project$Vector$length,
		A3($elm$core$List$map2, $author$project$Vector$rel, p1, p2));
	var vel = A3($elm$core$List$map2, $elm$core$Basics$fdiv, posDiff, tDiff);
	return posDiff;
};
var $author$project$Main$velocityChart = function (model) {
	return $mdgriffith$elm_ui$Element$html(
		A3(
			$terezka$line_charts$LineChart$view1,
			function ($) {
			...
			A2(
				...
				$author$project$Main$velocity(model))));
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$pressureChart(model),
							$author$project$Main$velocityChart(model)
						]))
				])));
};
