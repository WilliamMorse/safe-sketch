...
var $author$project$PressurePlot$defaultEvent = {height: 0, isPrimary: false, offsetX: 0, offsetY: 0, pageX: 0, pageY: 0, pointerId: -1, pointerType: $author$project$Pointer$Mouse, pressure: 0, screenX: 0, screenY: 0, tangentialpressure: 0, tiltX: 0, tiltY: 0, timestamp: 0, twist: 0, width: 0};
...
var $author$project$PressurePlot$init = _Utils_Tuple2(
	A2(
		...
		_List_fromArray(
			[$author$project$PressurePlot$defaultEvent]),
		_List_Nil),
...
var $author$project$PressurePlot$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Down':
				var ev = msg.a;
				return _Utils_eq(ev.pointerType, $author$project$Pointer$Pen) ? _Utils_Tuple2(
					A2(
						$author$project$PressurePlot$Model,
						_List_fromArray(
							[ev]),
			...
			default:
				...
				if (_v1.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						A2(
							$author$project$PressurePlot$Model,
							_Utils_ap(model.events, bundle.events),
							bundle.predictions),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$PressurePlot$NoOp = {$: 'NoOp'};
	...
	return $mdgriffith$elm_ui$Element$html(
		A3(
			...
			A2(
				...
				F2(
					function (x, y) {
						return A2($author$project$PressurePlot$Point, x, y.pressure);
					}),
				model.events)));
};
...
var $author$project$Vector2d$length2 = function (_v0) {
	var a1 = _v0.a;
	var a2 = _v0.b;
	return A2($elm$core$Basics$pow, a1, 2) + A2($elm$core$Basics$pow, a2, 2);
};
var $author$project$Vector2d$length = function (a) {
	return A2(
		$elm$core$Basics$pow,
		$author$project$Vector2d$length2(a),
		0.5);
};
var $author$project$Vector2d$subtract = F2(
	function (_v0, _v1) {
		var a1 = _v0.a;
		var a2 = _v0.b;
		var b1 = _v1.a;
...
var $author$project$Vector2d$rel = F2(
	function (a, b) {
		return A2($author$project$Vector2d$subtract, a, b);
	});
var $author$project$PressurePlot$velocity = function (model) {
	...
	var tDiff = A3($elm$core$List$map2, $elm$core$Basics$sub, t2, t1);
	var p1 = A2(
		$elm$core$List$map,
		function (e) {
			return _Utils_Tuple2(e.screenX, e.screenY);
		},
		model.events);
	var p2 = A2($elm$core$List$drop, 1, p1);
	var posDiff = A2(
		$elm$core$List$map,
		$author$project$Vector2d$length,
		A3($elm$core$List$map2, $author$project$Vector2d$rel, p1, p2));
	var vel = A3($elm$core$List$map2, $elm$core$Basics$fdiv, posDiff, tDiff);
	return vel;
};
...
var $author$project$PressurePlot$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always($author$project$PressurePlot$init),
		subscriptions: $author$project$PressurePlot$subscriptions,
		update: $author$project$PressurePlot$update,
		view: $author$project$PressurePlot$view
	});
