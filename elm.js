...
var $author$project$Pointer$defaultEvent = {altitudeAngle: 0, azimuthAngle: 0, height: 1, isPrimary: false, offsetX: 0, offsetY: 0, pageX: 0, pageY: 0, pointerId: 0, pointerType: $author$project$Pointer$Mouse, pressure: 0, screenX: 0, screenY: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, timeStamp: 0, twist: 0, width: 1};
...
var $author$project$Sketch$svgSketchSpace = function (model) {
	...
	return A2(
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					A2($elm$core$List$map, $author$project$Sketch$stroke, model.strokes),
					_List_fromArray(
					[
