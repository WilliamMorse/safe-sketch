...
{
	if (region.a$.aj === region.be.aj)
	{
		return 'on line ' + region.a$.aj;
	}
	return 'on lines ' + region.a$.aj + ' through ' + region.be.aj;
}
...
var $author$project$Main$FillIn = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$moveEvent = _Platform_incomingPort('moveEvent', $elm$json$Json$Decode$value);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Main$moveEvent($author$project$Main$FillIn)
			]));
};
													...
													return function (screenY) {
														return function (pageX) {
															return function (pageY) {
																return {cQ: height, c2: isPrimary, ak: offsetX, al: offsetY, di: pageX, dj: pageY, dm: pointerId, S: pointerType, dn: pressure, ds: screenX, dt: screenY, dL: tangentialpressure, d$: tiltX, d0: tiltY, d5: twist, d9: width};
															};
														};
													};
												};
...
var $author$project$Main$flattenCoalescedEvents = function (ev) {
	var _v0 = A2(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var event = msg.a;
				return (event.S === 2) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							s: A2(
								...
								_List_fromArray(
									[
										_Utils_Tuple2(event.ak, event.al)
									])),
							ai: event.S,
							aG: true
						}),
			...
			case 3:
				var portEvent = msg.a;
				var _v1 = $author$project$Main$flattenCoalescedEvents(portEvent);
				if (_v1.b) {
					var event = _v1.a;
							...
							model,
							{
								s: A2(
									...
									A2(
										$elm$core$List$map,
										function (e) {
											return _Utils_Tuple2(e.ak, e.al);
										},
										A2($elm$core$List$cons, event, restOfEvents))),
								Y: function (p) {
									return A2($elm$core$List$cons, p, model.Y);
								}(
									function (e) {
										return _Utils_Tuple2(e.ak, e.al);
									}(event)),
...
var $author$project$Main$blockContextMenu = function (msg) {
	return A2(
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {b$: 'a', aK: 'atv', b1: 'ab', b2: 'cx', b3: 'cy', b4: 'acb', b5: 'accx', b6: 'accy', b7: 'acr', a5: 'al', a6: 'ar', b8: 'at', aL: 'ah', aM: 'av', cb: 's', cf: 'bh', cg: 'b', ci: 'w7', ck: 'bd', cl: 'bdt', as: 'bn', cm: 'bs', at: 'cpe', cu: 'cp', cv: 'cpx', cw: 'cpy', E: 'c', av: 'ctr', aw: 'cb', ax: 'ccx', F: 'ccy', ah: 'cl', ay: 'cr', cz: 'ct', cB: 'cptr', cC: 'ctxt', cN: 'fcs', bg: 'focus-within', cO: 'fs', cP: 'g', aR: 'hbh', aS: 'hc', bj: 'he', aT: 'hf', bk: 'hfp', cS: 'hv', cV: 'ic', cX: 'fr', cZ: 'iml', c_: 'imlf', c$: 'imlp', c0: 'implw', c1: 'it', c3: 'i', bq: 'lnk', _: 'nb', bu: 'notxt', da: 'ol', dc: 'or', Q: 'oq', dg: 'oh', bB: 'pg', bC: 'p', dk: 'ppe', dp: 'ui', v: 'r', du: 'sb', dv: 'sbx', dw: 'sby', dx: 'sbt', dA: 'e', dB: 'cap', dC: 'sev', dI: 'sk', p: 't', dN: 'tc', dO: 'w8', dP: 'w2', dQ: 'w9', dR: 'tj', aI: 'tja', dS: 'tl', dT: 'w3', dU: 'w5', dV: 'w4', dW: 'tr', dX: 'w6', dY: 'w1', dZ: 'tun', bS: 'ts', U: 'clr', d6: 'u', a1: 'wc', bW: 'we', a2: 'wf', bX: 'wfp', a3: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.v) + ('-' + ($elm$core$String$fromInt(pos.cx) + ('-' + ($elm$core$String$fromInt(pos.d9) + ('-' + $elm$core$String$fromInt(pos.cQ)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {au: closing, j: _List_Nil, I: _List_Nil, B: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.B + ('{' + (renderValues(rule.I) + (rule.au + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.v) + (' / ' + ($elm$core$String$fromInt(position.v + position.cQ) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cx) + (' / ' + ($elm$core$String$fromInt(position.cx + position.d9) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.v) + ('-' + ($elm$core$String$fromInt(position.cx) + ('-' + ($elm$core$String$fromInt(position.d9) + ('-' + $elm$core$String$fromInt(position.cQ)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {cQ: height / size, aa: size, bU: vertical};
	});
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cb, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.av, $mdgriffith$elm_ui$Internal$Style$classes.F, $mdgriffith$elm_ui$Internal$Style$classes.b7])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cb, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.av, $mdgriffith$elm_ui$Internal$Style$classes.F, $mdgriffith$elm_ui$Internal$Style$classes.b5])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cb, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.av, $mdgriffith$elm_ui$Internal$Style$classes.b6])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cb, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.av, $mdgriffith$elm_ui$Internal$Style$classes.b4])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cb + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aS)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cb + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aT)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.b$]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.cg]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.dc]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.da]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.cX]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes._, $mdgriffith$elm_ui$Internal$Style$classes.dA, $mdgriffith$elm_ui$Internal$Style$classes.cf]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cz + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ah)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Main$svgCanvas = function (model) {
	var width = $elm$core$String$fromFloat(model.ae - 40);
	var height = $elm$core$String$fromFloat(model.ad - 40);
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					A2($elm$core$List$map, $author$project$Main$stroke, model.am),
					_List_fromArray(
					[
						$author$project$Main$stroke(model.Y)
					])
				])));
};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					'width = ' + $elm$core$String$fromFloat(model.ae)),
					$mdgriffith$elm_ui$Element$text(
					'height = ' + $elm$core$String$fromFloat(model.ad))
				])));
};
